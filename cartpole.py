# Thanks to https://github.com/neka-nat/ddp-gym/blob/master/env/cartpole_continuous.py
...
class CartPoleContinuousEnv(gym.Env):
    ...
    def _state_eq(self, st, u):
        ...
        force = max(min(self.max_force, u[0]), -self.max_force)
        ...
        return np.array([x, x_dot, theta, theta_dot]) + np.random.normal(0, self.std, size=4)
